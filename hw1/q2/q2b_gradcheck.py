...
def gradcheck_naive(f, x, gradient_text=""):
    ...
    while not it.finished:
        ...
        x[ix]+= h
        # calculate numerical gradient using centered difference (first var is loss and second var is gradients)
        numgrad = ((calc_f_plus_h[0] - calc_f_minus_h[0]) / (2*h))
        # analytical_gradient = grad[ix]
        ### END YOUR CODE
        # Compare gradients
